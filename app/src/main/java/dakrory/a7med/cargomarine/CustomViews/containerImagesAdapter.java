...
public class containerImagesAdapter extends RecyclerView.Adapter<containerImagesAdapter.ViewHolder> {
    private List<containersDetails.urlItem> listdata;
    private Activity activity;
    RecyclerView recyclerView;

    public containerImagesAdapter(RecyclerView recyclerView, List<containersDetails.urlItem> listdata, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        final containersDetails.urlItem myImageData = listdata.get(position);


        if(listdata.get(position).getType()==containersDetails.TYPE_FILE) {
